...
export const IMPROVEMENT_REGISTRY: ImprovementRecord[] = [
  ...
  },
  {
    ...
    furtherAttention: "Set the live secret in production before public launch.",
    id: 3,
  ...
  },
  {
    ...
    furtherAttention: "Use real first-seen dates for every legacy queue item.",
    id: 9,
    status: "needs_followup",
  ...
  },
  {
    ...
    furtherAttention: "Add editable assignment actions after reviewer accounts are finalized.",
    id: 10,
    status: "needs_followup",
  ...
  },
  {
    ...
    furtherAttention: "Continue resolving the remaining official replacement files.",
    id: 12,
    status: "needs_followup",
  ...
  },
  {
    ...
    furtherAttention: "Show per-result freshness once every search endpoint returns source metadata.",
    id: 17,
    status: "needs_followup",
  ...
  },
  {
    ...
    furtherAttention: "Connect every live search result to explanation metadata.",
    id: 18,
    status: "needs_followup",
  ...
  },
  {
    ...
    furtherAttention: "Add individual assignment and completion buttons.",
    id: 20,
    status: "needs_followup",
  ...
  },
  {
    ...
    furtherAttention: "Connect recurring automation once hosting and runtime jobs are selected.",
    id: 22,
    status: "needs_followup",
  ...
  },
  {
    ...
    furtherAttention: "Make notes editable with named manager attribution.",
    id: 23,
    status: "needs_followup",
    title: "Manager notes",
  },
  ...
  },
  {
    ...
    furtherAttention: "Attach exact file counts for each layer.",
    id: 30,
    status: "needs_followup",
  ...
  },
  {
    ...
    furtherAttention: "Add interactive review for low-confidence relationships.",
    id: 31,
    status: "needs_followup",
  ...
  },
  {
    ...
    furtherAttention: "Tune scoring weights after more audit history exists.",
    id: 32,
    status: "needs_followup",
  ...
  },
  {
    ...
    furtherAttention: "Add auto-grouping from future pipeline logs.",
    id: 33,
    status: "needs_followup",
